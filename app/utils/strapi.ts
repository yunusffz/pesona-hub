...
export const buildStrapiParams = (
          ...
          if (
            ...
            if (hasOperators) {
              ...
              Object.entries(value).forEach(([operator, operatorValue]) => {
                ...
                const finalKey = `filters[${fullPath}][${operator}]`;
                ...
                if (Array.isArray(operatorValue)) {
                  ...
                  // Join array values with comma for Strapi format
                  const arrayString = operatorValue.join(",");
                  params.append(finalKey, arrayString);
                } else {
                  params.append(finalKey, String(operatorValue));
                }
              });
            } else {
